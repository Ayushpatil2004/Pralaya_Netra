...
const ResetPassword = () => {
  ...
  const onSubmitOTP = async (e) => {
    ...
    const submittedCode = inputRefs.current.map(input => input.value).join('');
    ...
    setOtp(submittedCode); 
    
    try {

        const { data } = await axios.post(backendUrl + '/api/auth/verify-reset-otp', { email, otp: submittedCode });
